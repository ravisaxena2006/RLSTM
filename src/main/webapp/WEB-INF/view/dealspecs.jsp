...
<div class="container-fluid">
		...
		<form:form action="/save" method="post" modelattribute="deal">
			...
			<div class="row">
				...
				<div class="col-md-6">
					<label>RM / Bid Manager* </label><br> 
					<input type="text" name="BID_MANAGER" class="form-control" required> <label>Sales
						Contact Name*</label><br> <input type="text"
						name="SALES_CONTACT_NAME" class="form-control" required> 
						<label>Pre-Sales Contact Name*</label><br> <input type="text" 
				...
				<div class="col-md-6">
					...
					<label>Delivery Manager*</label><br> <input type="text" 
						...
						name="EFFORT_ESTIMATE_BY" class="form-control" required>

					<label>Efforts Approved By* </label><br> <input type="text" 
						name="EFFORT_APPROVED_BY" class="form-control" required>
				</div>
			</div>
			<hr>
<div class="panel-group">
    ...
    <div class="row">
				...
				<div class="col-md-6">
					<label>CRM ID/Project ID*</label><br> <input type="text"
						...
						<label>Customer Name*</label><br> <input type="text" name="CUSTOMER_NAME"
						class="form-control" required> 
						<label>CRM
						ID/Project ID Status*</label><br>
						<select name="PROJECT_ID_STATUS" class="form-control">
    ...
    <c:forEach items="${projectIdList}" var="project">
        <option value="${project.PROJECT_STATUS_ID}">${project.PROJECT_STATUS}</option>
						...
						<label>Opportunity
						Description</label><br> <input type="text"
						name="OPPORTUNITY_DESCRIPTION" class="form-control"> <label>RFP
						\ Bid Submission Date*</label><br> <input type="text"
						name="BID_SUBMISSION_DATE"  class="form-control datepicker" required>

				</div>
				<div class="col-md-6">

					<label>Intimation to Bid Audit Team for Large Deals</label><br>
					<input type="text" name="INTIMATION_TO_BID_AUDIT_TEAM" class="form-control"
						required> <label>Annual IT Spend of Customer</label><br>
					<input type="text" name="ANNUAL_IT_SPEND_OF_CUSTOMER" class="form-control">

					<label id="L_CONTRACT_SIGNED_STATUS">Contract (MSSA) signed (Y/N) </label><br>
					<select id="CONTRACT_SIGNED_STATUS" class="form-control">
      ...
      <div class= "panel-body">
			<div class="row">
				...
				<div class="col-md-6">
					...
					<label>1st time Outsourcing/Matured Outsourcer</label><br> <input
						type="text" name="MATURED_OUTSOURCED" class="form-control">
				</div>
				<div class="col-md-6">

					<label>Baseline (Existing FTEs/Contract Value)</label><br> <input
						type="text" name="BASELINE" class="form-control"> <label>Expected
						/ Winning /Target Price *</label><br> <input type="text" pattern="\d*" title=" Please Enter Number"
      ...
      <div class= "panel-body">
			<div class="row">
				...
				<div class="col-md-6">
					...
					<input type="text" name="LANGUAGE" class="form-control"> <label
						id="L_ANY_REBADGING">(a) Any Rebadging</label><br> <select
						id="ANY_REBADGING" class="form-control">
						<option value="none">None</option>
						<option value="yes">Yes</option>
						<option value="no">No</option>
					</select> <label>(b) if Yes, Is it new employment or transfer with
						liabilities</label><br> <input type="text" name="REBADGING_STATUS"
						class="form-control">
				...
				<div class="col-md-6">
					...
					<label>Location as bench available (or) need to send on
						...
						is Prime, who is Sub</label><br> <input type="text" name="IS_PRIME_SUB"
						class="form-control"> <label id="L_HOURS_BILLING_OFFSOURCE">9th
						Hour billing at offshore*</label><br> <select id="HOURS_BILLING_OFFSOURCE"
						class="form-control">
						<option value="none">None</option>
						<option value="yes">Yes</option>
						<option value="no">No</option>
    ...
    <div class="panel panel-default">
      ...
      <div class= "panel-body">
			<div class="row">
				...
				<div class="col-md-6">
					<label>Warranty Period, if any (in months)</label><br> <input pattern="\d*" title=" Please Enter Number"
						type="text" name="WARRANTY_PERIOD" class="form-control" required="required"> <label>Bank
						Guarantee (% or value)</label><br> <input type="text" name="BANK_GUARANTEE"
						pattern="\d*" title=" Please Enter Number" class="form-control">

				</div>
				<div class="col-md-6">
					<label id="L_transition">Transition Chargeable </label><br> <select
						id="transition" class="form-control">
						<option value="none">None</option>
						<option value="yes">Yes</option>
						<option value="no">No</option>
...
<div class="panel-group">
    <div class="panel panel-default">
      ...
      <div class= "panel-body">
			<div class="row">
				<div class="col-md-6">
					<label id="L_PRICING_MODEL_ID">Pricing Model*</label><br>
					
					<select name="PRICING_MODEL_ID" class="form-control">
    ...
    <c:forEach items="${modelList}" var="model">
        <option value="${model.PRICING_MODEL_ID}">${model.PRICING_MODEL}</option>
					...
					<label>Additional Costs (a) Service Credits</label><br> <input pattern="\d*" title=" Please Enter Number"
						type="text" name="ADDITIONAL_COST" class="form-control"> <label>(b)
				...
				<div class="col-md-6">
					<label>(d) Probability of meeting SLAs (in %)</label><br> <input pattern="\d*" title=" Please Enter Number"
						type="text" name="SLA_PROBABILITY" class="form-control"> <label>Delivery
    ...
    <c:forEach items="${currencyList}" var="quote">
        <option value="${quote.QUOTE_CURRENCY_ID}">${quote.QUOTE_CURRENCY}</option>
					 ...
					 <label>BA Commission (if applicable)</label><br> <input
