...
var projectdurationCount=document.getElementById("projectduration").value; 
	   ...
	   addMoreString += '<td align="left"><select name="boughtOuts['+row+'].quoteCurrencyId">'
        ...
        addMoreString +=  '<td align="left" class="y4"><Input type="text"  size =10class="'+horizontalClass+' ty4"  name="boughtOuts['+row+'].licenceYear4" value="" ></td>';
        ...
        addMoreString +=  '<td align="left" class="s4"><Input type="text"  size =10class="'+horizontalClass1+' sty4" name="boughtOuts['+row+'].supportYear4" value="" ></td>';
